...
public class MediaPlaybackService extends Service {
	...
	public void onDestroy() {
		...
		if (MusicUtils.AUDIOEFFECT_AGENCY.isAavailable()) {
			Intent i = new Intent(
					MusicUtils.AUDIOEFFECT_AGENCY.ACTION_CLOSE_AUDIO_EFFECT_CONTROL_SESSION);
			i.putExtra(MusicUtils.AUDIOEFFECT_AGENCY.EXTRA_AUDIO_SESSION,
					getAudioSessionId());
			i.putExtra(MusicUtils.AUDIOEFFECT_AGENCY.EXTRA_PACKAGE_NAME,
					getPackageName());
			sendBroadcast(i);
		}
		mPlayer.release();
	...
	public void activateSleepMode(long time, boolean imme)
	...
	private class MultiPlayer {
		...
		public void setDataSource(String path) {
			...
			if (MusicUtils.AUDIOEFFECT_AGENCY.isAavailable()) {
				Intent i = new Intent(
						MusicUtils.AUDIOEFFECT_AGENCY.ACTION_OPEN_AUDIO_EFFECT_CONTROL_SESSION);
				i.putExtra(MusicUtils.AUDIOEFFECT_AGENCY.EXTRA_AUDIO_SESSION,
						getAudioSessionId());
				i.putExtra(MusicUtils.AUDIOEFFECT_AGENCY.EXTRA_PACKAGE_NAME,
						getPackageName());
		...
		public void setAudioSessionId(int sessionId) {
			MusicUtils.AUDIO_SESSION_ID_AGENCY.set(mMediaPlayer, sessionId);
		}

		public int getAudioSessionId() {
			return MusicUtils.AUDIO_SESSION_ID_AGENCY.get(mMediaPlayer);
		}
	}
